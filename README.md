...
**What if LLMs responded with interactive UI instead of text?**
...
| Prompt | Response |
|--------|----------|
| *"I am 5'11. How would I look beside Trump?"* | An interactive height comparison with adjustable inputs |
| ![Height comparison](screenshots/donald_trump_height.png) | |
| *"Where is Hagia Sophia?"* | A live map with pin and coordinates |
| ![Map with Hagia Sophia](screenshots/map_hagia_sophia.png) | |
| *"How does topspin affect a tennis ball's bounce?"* | A physics simulator with tweakable parameters |
| ![Topspin simulation](screenshots/simulation_tennis_topspin.png) | |
